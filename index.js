...
function checkDataType(value) {
  let i = typeof(value);
  console.log(`Значення "${value}" має тип "${i}"`);
  return i
...
function getVariableType(variable) {
  let i = typeof(variable);
  let b;
  switch(i) {
    case("number"): b = "Це число";
    break;
    case("string"): b = "Це рядок";
    break;
    case("boolean"): b = "Це булеве значення";
    break;
    default: b = "Це інший тип";
  };
  return b;
